...
sys.path.append("C:/Users/Public/mycode/MLops-Project/Mlops_end_to_end")
...
FILE_KEY = "model.pkl"
model_loader = s3_connections.s3_operations(BUCKET_NAME, AWS_ACCESS_KEY, AWS_SECRET_KEY)
model = model_loader.fetch_pkl_from_s3(FILE_KEY)
# model = mlflow.pyfunc.load_model("models/cached_model")
